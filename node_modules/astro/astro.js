#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('/home/elsa/.vscode/extensions/wallabyjs.console-ninja-1.0.431/out/buildHook/index.js').default({tool: 'astro', checkSum: '2008b890c27ea2235e4969BBZQFggKB1QPAFgAUFYAXAJaAQoB', mode: 'build'}); } catch(cjsError) { try { import('file:///home/elsa/.vscode/extensions/wallabyjs.console-ninja-1.0.431/out/buildHook/index.js').then(m => m.default.default({tool: 'astro', checkSum: '2008b890c27ea2235e4969BBZQFggKB1QPAFgAUFYAXAJaAQoB', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
